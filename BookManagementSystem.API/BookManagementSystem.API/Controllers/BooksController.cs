...
namespace BookManagementSystem.API.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllBooks([FromQuery] string? queryString = null)
        {
            var books = await bookRepository.GetAllAsync();

            if(queryString != null)
            {
                books = books.Where(b => b.Name.ToUpper().Contains(queryString.ToUpper()));
        ...
        public async Task<IActionResult> GetBookByUrlHandle([FromRoute] string urlHandle)
        {
            ...
            {
                var BorrowUser = await applicationUserRepository.GetByIdAsync(book.CurrentlyBorrowedByUserId);
                borrower = BorrowUser.Name;
            }
        ...
        public async Task<IActionResult> UpdateBookById([FromRoute] Guid id, UpdateBookRequestDTO request)
        {
            ...
            var book = new Book
            {
                ...
                CurrentlyBorrowedByUserId = request.CurrentlyBorrowedByUserId,
                Genres = new List<Genre>()
            };
