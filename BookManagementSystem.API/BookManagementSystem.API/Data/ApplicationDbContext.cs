        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicationUser>().HasData(
                ...
                new ApplicationUser
                {
                    ...
                    NormalizedEmail = "swatantra@test.com".ToUpper(),
                    NormalizedUserName = "swatantra@test.com".ToUpper(),
                    PasswordHash = hasher.HashPassword(null, "Swatantra@123")
                },
                new ApplicationUser
                {
                    Id = userID3,
                    ...
                    NormalizedEmail = "avinash@test.com".ToUpper(),
                    NormalizedUserName = "avinash@test.com".ToUpper(),
                    PasswordHash = hasher.HashPassword(null, "Avinash@123")
                },
                new ApplicationUser
                {
                    Id = userID4,
                    ...
                    NormalizedEmail = "abhishek@test.com".ToUpper(),
                    NormalizedUserName = "abhishek@test.com".ToUpper(),
                    PasswordHash = hasher.HashPassword(null, "Abhishek@123")
                },
                new ApplicationUser
                {
                    Id = userID5,
                    ...
                    NormalizedEmail = "pranav@test.com".ToUpper(),
                    NormalizedUserName = "pranav@test.com".ToUpper(),
                    PasswordHash = hasher.HashPassword(null, "Pranav@123")
                }
            );
